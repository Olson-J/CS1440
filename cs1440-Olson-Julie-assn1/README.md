Fair warning I'm struggling to get the formating for the cut output right, but I don't know if I'm going to run out of time so I'm putting this here just in case it still doesn't work by midnight.
